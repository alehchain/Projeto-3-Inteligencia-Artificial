 ...
 * primeiro.
 * <p>
 * <img SRC="file:gomoku.gif" height=179 width=178> <br>
 * &nbsp; <br>
 * &nbsp; Esta Classe implementa o servidor GoMokuServer. <br>
 * N&Atilde;O ALTERE ESSA CLASSE.<br>
 * Ela se registra na porta porta 1962. Passa ent&atilde;o a receber as jogadas
 * dos jogadores e envi&aacute;-las para o oponente segundo um protocolo
 * pr&eacute;-definido. <br>
 * <br>
 * <b>Execu&ccedil;&atilde;o</b><br>
 * <center><i>java GoMokuServer</i></center> <br>
 * <br>
 * <b>Protocolo</b><br>
 ...
 * <center><i>&lt;x>\n&lt;y>\n</i></center> <br>
 * <br>
 * Caso o servidor receba o caracter # de um jogador significa que ocorreu algum
 * problema e o jogador estï¿½ desistindo <br>
 * A jogada enviada possui o seguinte format:<br>
 * <center><i>&lt;jogador>\n&lt;x>\n&lt;y>\n</i></center> <br>
 * Onde:
 * <ul>
 * <li>&lt;jogador>= indica qual &eacute; a cor do jogador (Tabuleiro.AZUL ou
 * Tabuleiro.VERM) ou '#' indicando fim do jogo.
 * <li>&lt;x>&lt;y> = s&atilde;o as coordenadas da jogada (0 a 7).
 * </ul>
 * <br>
 * <p>
 * <br>
...
public final class TabuleiroGoMoku implements Tabuleiro {
     ...
     *
     * @param aabTab Array contendo os valores para a inicializa&ccedil;&atilde;o.
     */
    ...
    public int heuristicaBasica(byte jogador, byte tab[][]) {
        ...
        // imprimeTab(tab);
        // System.out.println("valor do tabuleiro:" + valor + " -- para jogador:" +
        // jogador);
        return valor;
    }
    ...
    public boolean fimJogo() {
        ...
        if (obtemJogadasPossiveis(AZUL) != null || obtemJogadasPossiveis(VERM) != null) {
            return false;
        }
     ...
     * direcao especificada. O s valores da direcao definida por dirX e dirY devem
     * ser 0, 1, or -1, sendo que um deles deve ser diferente de zero.
     */
    private int count(byte jogador, int linha, int coluna, int dirX, int dirY) {
        int ct = 0; // Numero de pecas em linha de um jogador.
        ...
        System.out.println("Contagem:" + ct);
        return ct;
     ...
     * direcao definida por dirX e dirY devem ser 0, 1, or -1, sendo que um deles
